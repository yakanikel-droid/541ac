...
public:                                                 // senders
    void ReinitializeForRaceMask(uint32 raceMask);
...
private:                                                // internal helper functions
    void Initialize();
    int32 GetBaseReputationForRaceMask(FactionEntry const* factionEntry, uint32 raceMask) const;
    uint32 GetDefaultStateFlags(FactionEntry const* factionEntry) const;
    uint32 GetDefaultStateFlagsForRaceMask(FactionEntry const* factionEntry, uint32 raceMask) const;
